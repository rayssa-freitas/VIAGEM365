...
1. Draw.io para a diagramação;
2. Trello em um quadro de modelo Kanban para a organização das tarefas que seriam executadas;
3. Visual Studio Code
4. Postgress para a organização do Banco de Dados, e a comunicaçã
5. Sequelize para comunicação com o Banco de dados
## Rodar o repositório:
